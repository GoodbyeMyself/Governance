    ...
    const handleMouseMove = (e) => {
        if (linking) {
            ...
            setLinkingLine({
                ...linkingLine,
                endX:
                    (e.clientX - rect.left - transform.pan?.x) / transform.zoom,
                endY:
                    (e.clientY - rect.top - transform.pan?.y) / transform.zoom,
            });
        } else if (
            panning.isPanning &&
            ...
            if (areaResize.dir === "br") {
                ...
                newDims.height =
                    initCoords.height + (mouseY - initCoords.mouseY);
    ...
    const handleLinking = () => {
        ...
        const newRelationship = {
            ...
            name: `${tables[linkingLine.startTableId].name}_${
                tables[linkingLine.startTableId].fields[

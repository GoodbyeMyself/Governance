                ...
                await axios
                    .post(`${import.meta.env.VITE_BACKEND_URL}/send_email`, {
                        ...
                        message: `${Object.keys(form).map(
                            (k) =>
                                `<div>${questions[k]}</div><div>${form[k]}</div>`,
        ...
        <div className="py-5 px-8 mt-6 card-theme rounded-md">
            ...
            {form.triedOtherApps === "yes" && (
                <div className="my-3">
                    ...
                    <TextArea
                        ...
                        onChange={(v) =>
                            setForm((prev) => ({ ...prev, comparison: v }))
                        }
                    />
                </div>
            )}
            ...
            <div className="flex justify-between items-center">
                <div className="text-sm opacity-80">
                    <i className="fa-brands fa-markdown me-1"></i>Styling with
        ...
        <div>
            ...
            <div className="md:w-[90%] w-[74%] mx-auto my-8">
                <Banner
                    ...
                    description={
                        <div>
                            Thanks for taking this survey! We highly value your
                            feedback and strive to make drawDB fit your needs
                            better.
                        </div>
                    }
                />
